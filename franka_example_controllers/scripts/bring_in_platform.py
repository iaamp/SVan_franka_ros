...
class Bring_in_platform:
    ...
    def __init__(self):
        ...
        ros.loginfo("bring_in_platform: Waiting for '" + self.action + "' action to come up")
        self.client.wait_for_server()

        self.param_0 = ros.resolve_name('~ws_center_joint_pose')
        self.param_1 = ros.resolve_name('~intermediate_joint_pose_1')
        self.param_2 = ros.resolve_name('~lift_platform_joint_pose')
        self.param_3 = ros.resolve_name('~grab_platform_joint_pose')
        self.param_4 = ros.resolve_name('~approach_platform_joint_pose')
        self.param_5 = ros.resolve_name('~intermediate_joint_pose_0')
        self.param_6 = ros.resolve_name('~start_joint_pose')
    ...
    def main(self):
        ...
        for i, pose in enumerate(self.poses):
            ...
            if result.error_code != FollowJointTrajectoryResult.SUCCESSFUL:
                ros.logerr('ring_in_platform: Movement was not successful: ' + {
                ...
                ros.loginfo('bring_in_platform: Successfully stored platform at base station')




bring_in_platform = Bring_in_platform()